...
public abstract class GameRendererMixin {
    ...
    @ModifyArg(method = {"setupCamera", "renderWorld(IFJ)V", "method_9777"}, at = @At(value = "INVOKE:LAST", target = "Lorg/lwjgl/util/glu/Project;gluPerspective(FFFF)V"), index = 3)
    ...
    @ModifyArg(method = {"method_9777"}, at = @At(value = "INVOKE:FIRST", target = "Lorg/lwjgl/util/glu/Project;gluPerspective(FFFF)V"), index = 3)
