...
public abstract class GameOptionsMixin {
    ...
    @Dynamic
    @ModifyExpressionValue(method = "getFLoatOption", at = @At(value = "FIELD", target = "Lnet/minecraft/client/option/GameOptions;vsync:Z"))
    private boolean removeAdditionalFPSSliderLogic(boolean original) {
        return false;
    }

    @Dynamic
    @Redirect(method = "setOption(Lnet/minecraft/client/option/GameOption;F)V", at = @At(value = "FIELD", target = "Lnet/minecraft/client/option/GameOptions;vsync:Z"))
    ...
    @Dynamic
    @ModifyConstant(method = "setOptionValueOF(Lnet/minecraft/class_350;I)V", constant = @Constant(intValue = 5), remap = false)
    ...
    @Dynamic
    @Redirect(
            method = "setOptionValueOF(Lnet/minecraft/class_350;I)V",
